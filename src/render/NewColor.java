...
public class NewColor extends JPanel{
	private BufferedImage C0,C1,C2,C3,C4,C5,C6,C7;
	...
	protected void paintComponent(Graphics g) {
		...
		if(PlayerStatus.getRoundstate()==1) g.drawImage(C1, 0, 0, null);
		else if(PlayerStatus.getRoundstate()==2) g.drawImage(C2, 0, 0, null);
		else if(PlayerStatus.getRoundstate()==4) g.drawImage(C3, 0, 0, null);
		else if(PlayerStatus.getRoundstate()==6) g.drawImage(C4, 0, 0, null);
		else if(PlayerStatus.getRoundstate()==7) g.drawImage(C5, 0, 0, null);
		else if(PlayerStatus.getRoundstate()==10) g.drawImage(C6, 0, 0, null);
		else if(PlayerStatus.getRoundstate()==12) g.drawImage(C7, 0, 0, null);
		else g.drawImage(C0, 0, 0, null);
	}
}
